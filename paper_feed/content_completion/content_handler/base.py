...
class ContentHandler:
    ...
    def _get_request_urls(self, paper_list: list[Paper]) -> list[str]:
        """Abstract method to build urls to retrieve the publisher related paper information.
    ...
    def get_paper_contents_from_request_content(
        ...
        """Abstract method to retrieve paper data from the request content.
    ...
    def get_request_info(self, paper_list: list[Paper]) -> dict:
        ...
        request_info = {
            ...
            "identifiers": self._get_request_identifiers(paper_list),
        }
        return request_info
