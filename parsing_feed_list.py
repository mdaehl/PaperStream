...
def parse_feed_list(use_config_file: bool, source_file: str, target_file: str, online: bool, appending: bool, remove_duplicates_within_feed: bool, remove_duplicates_across_feeds: bool):
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument(
        "--target",
        "-t",
        help="Name of the result feed file (target_file) without extension.",  type="str"
    )
    arg_parser.add_argument(
        "--online", "-o", type=bool, help="Whether the feed file is stored online."
    )
    arg_parser.add_argument(
        "-a", "--append", type=bool, help="Append new entries to current feed file"
    )
    arg_parser.add_argument(
        "--remove_within",
        type=bool,
    ...
    parse_feed_list(use_config_file=input_args.use_config,
